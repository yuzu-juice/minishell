...
/*   Updated: 2025/03/30 18:34:46 by yohatana         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/minishell.h"

static bool	create_quote_word(char *line, int *index, t_token **head);
...
static bool	create_token_word(int *start, char *line, t_token **head)
{
	...
	j = *start + 1;
	while (!is_split_char(line[j]) && !is_quote(line[j]) && j < len)
		j++;
